...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
        <form action="{{ route('audit-logs.lead-logs') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('audit-logs.lead-logs') }}" class="px-6 py-2 border rounded-lg hover:bg-slate-50 transition-colors">
                    Limpiar
                </a>
            </div>
        </form>
