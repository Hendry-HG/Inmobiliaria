...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-100">
                        <div class="flex items-center gap-2 text-sm text-slate-600">
                            ...
                            <span>Miembro desde: <strong>{{ $user->created_at->format('d/m/Y') }}</strong></span>
                        </div>
        ...
        <div class="lg:col-span-2">
            {{-- ============================================= --}}
            {{-- FORMULARIO - Solo con permiso de editar perfil --}}
            {{-- ============================================= --}}
            @can('editar usuario')
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            @else
                ...
                <div class="bg-red-50 border border-red-200 text-red-700 p-6 rounded-lg text-center">
                    ...
                    <p class="text-sm">No tienes permisos para editar tu perfil.</p>
                </div>
            @endcan
        </div>
    </div>
