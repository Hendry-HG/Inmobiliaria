...
<style>
    ...
    @media (max-width: 768px) {
        ...
        /* Sidebar en móvil - ocupa toda la pantalla correctamente */
        .sidebar-mobile {
            position: absolute;
            top: 0;
            left: 0;
        ...
        /* Chat en móvil - ocupa toda la pantalla correctamente */
        .chat-mobile {
            position: absolute;
            top: 0;
            left: 0;
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="px-4 py-3 bg-white border-b flex items-center justify-between flex-shrink-0">
                    <div class="flex items-center gap-3">
                        <img :src="currentConversation.other_user.avatar" class="w-10 h-10 rounded-full object-cover">
                        <div>
                ...
                <form @submit.prevent="sendOrUpdateMessage" class="p-3 bg-white border-t flex-shrink-0">
                    <div class="flex gap-2">
                        ...
                        <button type="submit" :disabled="!editingMessage.trim()"
            ...
            <div class="max-h-96 overflow-y-auto">
                <template x-for="asesor in asesoresDisponibles" :key="asesor.id">
                    <div @click="startConversationWithAsesor(asesor.id)" class="p-3 border-b hover:bg-slate-50 cursor-pointer flex items-center gap-3">
                        <img :src="asesor.avatar" class="w-12 h-12 rounded-full object-cover">
                        <div class="flex-1">
            ...
            <div class="max-h-96 overflow-y-auto">
                <template x-for="cliente in clientesDisponibles" :key="cliente.id">
                    <div @click="startConversationWithCliente(cliente.id)" class="p-3 border-b hover:bg-slate-50 cursor-pointer flex items-center gap-3">
                        <img :src="cliente.avatar" class="w-12 h-12 rounded-full object-cover">
                        <div class="flex-1">
    ...
    function chatApp() {
        return {
                    ...
                    div.innerHTML = `
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3 flex-1">
                                <img src="${this.escapeHtml(conv.other_user.avatar)}" class="w-10 h-10 rounded-full object-cover">
            ...
            async confirmDeleteMessage() {
                ...
                try {
                    await fetch(`/chat/message/${this.messageToDelete}`, {
                        method: 'DELETE',
            ...
            async confirmDeleteConversation() {
                ...
                try {
                    await fetch(`/chat/conversation/${this.conversationToDelete}`, {
                        method: 'DELETE',
                        headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content }
                    });
