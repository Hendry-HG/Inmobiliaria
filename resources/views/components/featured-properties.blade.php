...
<section id="propiedades" class="py-8 sm:py-12 md:py-20 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
    ...
    @if($properties && $properties->count() > 0)
        ...
        <div class="w-full relative">
            <div class="swiper featured-carousel swiper-container relative overflow-visible">
                        ...
                        <div class="swiper-slide h-auto !flex !justify-center">
                            <div class="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group h-full flex flex-col w-full"
                                ...
                                <div class="relative h-48 xs:h-52 sm:h-56 md:h-60 lg:h-64 overflow-hidden bg-slate-200 flex-shrink-0">
                                    ...
                                    {{-- Badge "Destacada" --}}
                                    <div class="absolute top-2 right-2 sm:top-3 sm:right-3 bg-amber-500 text-white text-[8px] xs:text-[10px] sm:text-xs font-bold px-1.5 sm:px-2 md:px-3 py-0.5 sm:py-1 rounded-full shadow-lg flex items-center gap-0.5 sm:gap-1 z-10">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 256 256" class="text-[8px] sm:text-[10px]">
                                            <path fill="currentColor" d="M239.2,97.4A16.4,16.4,0,0,0,224.6,86l-59.4-4.1l-22.9-55A16.4,16.4,0,0,0,128,22.6a16.4,16.4,0,0,0-14.3,9.3L90.8,81.9L31.4,86A16.4,16.4,0,0,0,16.8,97.4a16.1,16.1,0,0,0,4.7,17.7l44.7,38.1l-14.7,58.4a16.5,16.5,0,0,0,6,17.3a16.8,16.8,0,0,0,18.4,1.2L128,192.7l51.1,32.4a16.8,16.8,0,0,0,18.4-1.2a16.5,16.5,0,0,0,6-17.3L188.8,148l44.7-38.1A16.1,16.1,0,0,0,239.2,97.4Z"/>
                                        </svg>
                                        <span class="hidden xs:inline">Destacada</span>
                                    </div>
        ...
        <style>
            ...
            .featured-carousel .swiper-slide > div {
                width: 100%;
                max-width: 340px;
                margin: 0 auto;
            }
            ...
            .featured-carousel .swiper-slide .absolute.bottom-2.left-2,
            .featured-carousel .swiper-slide .absolute.bottom-3.left-3 {
                max-width: 55%;
                overflow: hidden;
            ...
            .featured-carousel .swiper-slide .absolute.bottom-2.right-2,
            .featured-carousel .swiper-slide .absolute.bottom-3.right-3 {
                max-width: 45%;
            }
        </style>
    @else
        <div class="text-center py-8 sm:py-12 text-slate-400 bg-white rounded-2xl shadow-sm">
            ...
            <p class="text-base sm:text-lg">No hay propiedades destacadas disponibles.</p>
            <p class="text-sm sm:text-base text-slate-400">Configura las propiedades destacadas desde el panel de administración.</p>
        </div>
    @endif
</section>
