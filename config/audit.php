...
return [
    ...
    | Usamos nuestro modelo personalizado AuditLog
    |
    */
    ...
    */
    ...
    'exclude' => [
        // Excluir campos sensibles a nivel global
        'password',
        'remember_token',
        'api_token',
        'sanctum_token',
    ...
    */
    'allowed_array_values' => true, // Cambiamos a true para auditar campos como social_links
    ...
    */
    ...
    'timestamps' => false, // Lo dejamos en false para no auditar timestamps automáticos
    ...
    */
    ...
    'drivers' => [
        'database' => [
            'table' => 'audit_logs', //  tabla personalizada
            'connection' => null,
        ],
    ],
